...
int postalCode = 360007;
int postalCode = -20;
int postalCode = null; // this will give an error.
...
void main(){
Name p1=Name(givenName: "utsav");
Name p2=Name(givenName: "utsav",surname: "sheth");
Name p3=Name(givenName: "utsav",surnameIsFirst: true,surname: "sheth");
print(p1);
print(p2);
print(p3);
}
